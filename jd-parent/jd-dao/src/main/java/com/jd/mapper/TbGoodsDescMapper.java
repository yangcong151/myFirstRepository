...
public interface TbGoodsDescMapper {
    ...
    List<TbGoodsDesc> selectByExampleWithBLOBs(TbGoodsDescExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") TbGoodsDesc record, @Param("example") TbGoodsDescExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(TbGoodsDesc record);
